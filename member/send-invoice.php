<?php
	if(isset($_GET['kirim'])){
		...
		$fileatt_name = $kode_perusahaan.$res0['id_user'];
		$dir='./invoice/';
		...
		// set email message......................
		$email_message = "No Virtual Pembayaran Anda : ".$kode_perusahaan.$res0['id_user'].", Tanggal akhir pembayaran pertama : 12 maret 2016.<br>";
