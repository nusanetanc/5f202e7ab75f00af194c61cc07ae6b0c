...
$add_payment = $col_payment->insert(array("id_user"=>$id_cust, "tanggal_bayar"=>$tanggal_bayar, "tanggal_konfirmasi"=>$date, "total_tagihan"=>$total_tagihan, "ppn"=>$ppn, "no"=>$pembayaran,"total_pembayaran"=>$total_pembayaran));
if($add_payment){
$total=0;
$res = $col_user->findOne(array("id_user"=>$id_cust));
foreach ($res['payment_data'] as $payment => $pay) {
