...
if(isset($_POST['terminasi'])){
	...
	$update_user = $col_user->update(array("id_user"=>$id_cust, "level"=>"0"), array('$set'=>array("tanggal_akhir"=>$termination_date, "status"=>"Tidak Aktif")),array('$push'=>array("termination"=>$termination))); 
				// mail for supevisior teknik
