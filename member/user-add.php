...
if ($add_support){ 
	...
	?>
		...
		document.location='<?php echo $base_url_member; ?>/?hal=user-list'</script>
<?php	}
}
?>
<section>
								  ...
								  <fieldset>
									...
									<div class="form-group">
									  <label class="control-label" for="inputJab">Jabatan</label>
									  	<select class="form-control" id="inputJab" name="inputJab">
								          <option selected="true" disabled="true">Pilih Jabatan</option>
								          <option value="1">Direktur</option>
								          <option value="5">Sales Manager</option>
								          <option value="3">Spv Support</option>
								          <option value="4">Spv Helpdesk</option>
