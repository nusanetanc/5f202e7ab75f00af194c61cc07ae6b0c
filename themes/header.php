                                                                        ...
                                                                        // mail for customer to forgote password
                                                                            ...
                                                                            <html>
                                                                                <body style="background-color:#f0f0f0;padding:50px 0 50px 0;font-family:arial;font-size:15px;">
                                                                                    <div style="margin:0 auto;max-width:500px;background-color:#efefef;-moz-border-radius: 0px;-webkit-border-radius: 5px 5px 5px 5px;border-radius: 5px 5px 5px 5px;">
