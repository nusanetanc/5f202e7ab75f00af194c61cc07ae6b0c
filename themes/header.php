...
<body data-spy="scroll" data-target=".supportMenuWrapper" data-offset="50" style="position:relative;background-color:#e0e0e0;">
    ...
    z-index:1000;">
        <div class="logoWrapper">
            ...
            <a href="<?php echo $base_url; ?>"><img src="<?php echo $base_url; ?>/img/groovy-logo-white.png" width="200px" height="50px"/></a>
        </div>
...
<body>
    ...
    ">
        <div class="logoWrapper">
            <a href="<?php echo $base_url; ?>"><img src="<?php echo $base_url; ?>/img/groovy-logo2.png"  height="50px"/></a>
        </div>
        <div style="float:right;margin-left:15px;margin-top:14px;">
