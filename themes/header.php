...
<body>
    ...
    ">
        ...
        <div style="float:right;margin-left:15px;margin-top:14px;">
            <a href="<?php echo $base_url; ?>/features" class="navMenu" style="color:#ff6d00;">FEATURES</a>
            <a href="<?php echo $base_url; ?>/packages" class="navMenu" style="color:#ff6d00;">PACKAGES</a>
            <a href="<?php echo $base_url; ?>/support" class="navMenu" style="color:#ff6d00;">SUPPORT</a>
