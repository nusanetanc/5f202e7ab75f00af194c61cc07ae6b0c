...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul  class="dropdown nav navbar-nav navbar-right navbar-primary desktop-only">
        <li class="dropdown-toggle" data-toggle="dropdown">
          <i style="width:45px;height:45px;margin-top:7px;margin-left:10px;cursor:pointer" class="profile-img-card profile-img-card-mdm fa fa-bell-o" aria-hidden="true"></i>
        </li>
      </ul>
      <ul  class="dropdown nav navbar-nav navbar-right navbar-primary desktop-only">
          <li class="dropdown-toggle" data-toggle="dropdown">
